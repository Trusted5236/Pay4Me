...
const Section2A = () => {
  return (
    <div style={{
        ...
        <div className='flex flex-col  gap-y-[16px] md:gap-y-[32px] items-center md:items-start'>
        ...
        <div className='w-full flex flex-row items-center flex-wrap md:justify-between justify-center gap-y-[1rem]'>
        <div className='p-[16px] md:p-[32px] flex flex-col gap-y-[24px] md:gap-y-[30px] w-[80%] md:w-[30%] bg-[#FFFFFF] rounded-[24px] items-center md:items-start'>
            <img src="Frame (1).png" className='md:w-[48px] w-[25px]'/>
            <h1 className='font-bold text-[15px] md:text-[22px]'>Global Accessibility</h1>
            <p className='text-[10px] md:text-[14px] text-center md:text-start'>Effortlessly send tuition and other payments to educational institutions worldwide, no matter where you are.</p>
        ...
        <div className='p-[16px] md:p-[32px] flex flex-col gap-y-[24px] md:gap-y-[30px] w-[80%] md:w-[30%] bg-[#FFFFFF] rounded-[24px] items-center md:items-start'>
            ...
            <p className='text-[10px] md:text-[14px] text-center md:text-start'>Ensure your payments are processed quickly, helping you meet important deadlines without stress.</p>
            <button className='flex flex-row items-center px-[8px] md:px-[16px] py-[6px] md:py-[12px] rounded-[33px] gap-x-[6px] md:gap-x-[12px] bg-[#AFE274] border-[1px] border-[#A4C47D] w-[100px] md:w-[140px]  text-[10px] md:text-[12px]'>Dowload app <LuScanLine /></button>
        </div>
        ...
        <div className='p-[16px] md:p-[32px] flex flex-col gap-y-[24px] md:gap-y-[30px] w-[80%] md:w-[30%] bg-[#FFFFFF] rounded-[24px] items-center md:items-start'>
            ...
            <p className='text-[10px] md:text-[14px] text-center md:text-start'>Enjoy peace of mind with secure payment processing and complete transparency on fees and conversion rates.</p>
            <button className='flex flex-row items-center px-[8px] md:px-[16px] py-[6px] md:py-[12px] rounded-[33px] gap-x-[6px] md:gap-x-[12px] bg-[#AFE274] border-[1px] border-[#A4C47D] w-[100px] md:w-[140px]  text-[10px] md:text-[12px]'>Dowload app <LuScanLine /></button>
        </div>
