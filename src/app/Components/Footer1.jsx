...
const Footer1 = () => {
  return (
    <div className='p-[2rem] w-full h-auto flex flex-row items-start flex-wrap justify-between gap-y-[1rem] border-b-[0.5px] border-[#D8D8D8]'>
      ...
      <div className='flex flex-col md:gap-y-[18px] gap-y-[9px] items-start text-[0.8rem] md:text-[1rem]'>
      ...
      <p className='text-[#5D5D5D] flex flex-row items-center gap-x-[0.5rem] '><MdOutlineMailOutline className='border-[0.5px] rounded-full text-[1.8rem] p-[0.5rem]'/> support@pay4me.app</p>
        ...
        <FaInstagram className='bg-black rounded-full text-white text-[1.8rem] p-[0.5rem]'/>
        <FaXTwitter className='bg-black rounded-full text-white text-[1.8rem] p-[0.5rem]'/>
        <FaFacebookF className='bg-black rounded-full text-white text-[1.8rem] p-[0.5rem]'/>
        <FaTiktok className='bg-black rounded-full text-white text-[1.8rem] p-[0.5rem]'/>
        <FaYoutube className='bg-black rounded-full text-white text-[1.8rem] p-[0.5rem]'/>
        </div>
      </div>

      <div className='text-[0.8rem] md:text-[1rem] flex flex-col md:gap-y-[18px] gap-y-[9px] items-start'>
      ...
      <div className='flex flex-row md:gap-x-[16px] gap-x-[8px] items-center'>
        ...
        <p className='text-[0.8rem] md:text-[1rem] text-[#5D5D5D]'>Depending on your mobile device, download our awesome native app to start enjoying all the benefits of pay4Me.</p>
      </div>
